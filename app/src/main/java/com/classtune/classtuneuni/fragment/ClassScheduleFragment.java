...
public class ClassScheduleFragment extends Fragment implements ClassScheduleAdapter.ItemListener {
    ...
    private ArrayList<ClassScheduleModel> scheduleList;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        scheduleList.add(new ClassScheduleModel( "Monday","10", "July, 2019", "10:30am - 12:00pm"));
        scheduleList.add(new ClassScheduleModel( "Monday","10", "July, 2019", "10:30am - 12:00pm"));
        scheduleList.add(new ClassScheduleModel( "Monday","10", "July, 2019", "10:30am - 12:00pm"));
        scheduleList.add(new ClassScheduleModel( "Monday","10", "July, 2019", "10:30am - 12:00pm"));
        ...
        ClassScheduleAdapter examListAdapter = new ClassScheduleAdapter(getActivity(), scheduleList, this);
