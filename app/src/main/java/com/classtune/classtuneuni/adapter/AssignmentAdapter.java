...
public class AssignmentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<AssignmentModel> mValues;
    private Context mContext;
    protected ItemListener mListener;
    private static final int HERO = 2;
    private static final int ITEM = 0;

    public AssignmentAdapter(Context context, ArrayList<AssignmentModel> values, ItemListener itemListener) {
        mValues = values;
        mContext = context;
...
//                break;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int position) {
        final AssignmentModel result = mValues.get(position);
