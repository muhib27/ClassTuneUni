...
public class StCourseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public StCourseAdapter(Context context, PaginationAdapterCallback mCallback) {
