...
public class ExamPublishedListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<Exam> mValues;
...
//                if (subjectResultModel.getExams() != null) {
//
//                    for (int i = 0; i < subjectResultModel.getExams().size(); i++) {
                        if(count == 0) {
...
//            praticipantText = itemView.findViewById(R.id.participantText);
    ...
    public void addAllData(List<Exam> moveResults , String title) {
        count = 0;
        this.title = title;
