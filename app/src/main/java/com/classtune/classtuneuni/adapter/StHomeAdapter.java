...
public class StHomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public StHomeAdapter(Context context) {
...
//        return new ViewHolder(view);
        ...
        switch (viewType) {
            ...
            case NOTICE:
                View viewHero = inflater.inflate(R.layout.home_notice_item_row, parent, false);
        ...
        switch (getItemViewType(position)) {
            ...
            case ASSIGNMENT:
                ...
                if(position>0 && PREVIOUS_ID.equals(CURRENT_ID)) {
                    assignmentHolder.pic.setVisibility(View.INVISIBLE);
                    assignmentHolder.name.setVisibility(View.GONE);
                }
